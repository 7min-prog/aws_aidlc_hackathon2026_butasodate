...
final _categoriesProvider = FutureProvider<List<dynamic>>((ref) async {
  try {
    ...
    final res = await dio.get('${AppConfig.recordingApiBase}/categories');
...
class CategorySelectScreen extends ConsumerWidget {
  ...
  static String _catIcon(String iconKey) {
    const map = {
    ...
    return 'assets/pixel-art/icons/${map[iconKey] ?? 'cat-ramen'}.svg';
  }
  @override
            ...
            for (final cat in list) GestureDetector(
              ...
              child: Container(
                ...
                child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
                  SizedBox(width: 36 * sx, height: 36 * sx, child: SvgPicture.asset(CategorySelectScreen._catIcon(cat['iconKey'] ?? ''))),
