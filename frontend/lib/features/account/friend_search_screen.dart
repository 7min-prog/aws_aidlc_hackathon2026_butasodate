  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Stack(children: [
        ...
        // けんさくボタン
        Positioned(top: 20 * sy, left: 312 * sx, child: Container(
        ...
        // けっか
        Positioned(top: 76 * sy, left: 14 * sx, child: Text('けっか', style: TextStyle(fontFamily: kFontDotGothic16, fontSize: 11, color: ButaColors.gray))),
        // 検索結果
        Positioned(top: 96 * sy, left: 14 * sx, child: Container(
          width: 362 * sx, height: 52 * sy,
          padding: EdgeInsets.symmetric(horizontal: 12 * sx),
          decoration: BoxDecoration(color: ButaColors.paper, border: Border.all(color: ButaColors.ink, width: 1)),
          child: Row(children: [
            Container(width: 36 * sx, height: 36 * sy, color: ButaColors.blue, alignment: Alignment.center, child: SvgPicture.asset('assets/pixel-art/icons/pig.svg', width: 16.0, height: 16.0)),
